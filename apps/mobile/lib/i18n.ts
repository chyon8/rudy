...
const en = {
  ...
  home: {
    ...
    label_timing: 'Good timing',
    label_rising_interest: 'On your mind',
    label_maturity: 'Rediscovered',
    label_connection: 'Connected',
    label_surprise: 'A curveball',
    label_cold_start: 'Just saved',
  ...
  capture: {
    placeholder: 'A link, a thought, something you want to do…',
    gotIt: 'Got it.',
...
const ko: typeof en = {
  ...
  onboarding: {
    ...
    firstSaveTitle: '첫 기억을 심어보자',
    firstSaveBody: '다시 보려던 링크를 붙여넣거나, 지금 떠오른 생각을 적어도 좋아.',
    firstSavePlaceholder: '링크든, 생각이든, 하고 싶은 거든…',
    firstSaveCta: '심기',
    planting: 'Rudy가 첫 기억을 읽고 있어…',
  },
  home: {
    stillReading: 'Rudy가 지금 읽는 중이야',
    discoveryLabel: '새로운 발견',
    reflectionLabel: '요즘의 나',
    label_timing: '지금 타이밍',
    label_rising_interest: '요즘 관심',
    label_maturity: '다시 발견',
    label_connection: '이어진 기억',
    label_surprise: '결이 다른 것',
    label_cold_start: '방금 저장',
    savedToday: '오늘 저장',
    savedDaysAgo: '{{count}}일 전 저장',
    closing: '오늘은 여기까지. 내일 또 준비해둘게.',
    open: '열기',
    like: '좋아요',
    notToday: '오늘은 말고',
    stopShowing: '그만 보기',
    stopShowingConfirm: '이 기억은 다시 꺼내오지 않을게.',
    offline: '마지막 브리핑을 보여주고 있어 — 네트워크가 잠시 자리를 비웠네.',
  },
  capture: {
    placeholder: '링크든, 생각이든, 하고 싶은 거든…',
    gotIt: '잘 받았어.',
    queued: '저장했어 — 연결되면 알아서 보낼게.',
  },
  library: {
    all: '전체',
    interests: '관심사',
    search: '검색',
    searchPlaceholder: '저장해둔 그것, 찾아줄게',
    emptyAll: '저장한 것들이 여기에 모여.',
    emptyInterests: '저장할수록 관심사가 모양을 갖춰가.',
    emptySearch: '딱 맞는 게 없었어. 다른 말로 찾아볼까?',
    memoriesCount: '{{count}}개 기억',
    linkGone: '이 링크는 더 이상 열리지 않아',
  },
  memory: {
